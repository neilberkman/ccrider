...
Search, browse, and resume Claude Code, Codex CLI, GitHub Copilot CLI, OpenCode, and Pi sessions, plus an MCP server so agents can remember past context.
...
# Launch the TUI - browse, search, and resume supported providers
ccrider tui
...
- Native resume - one keystroke to resume Claude Code, Codex CLI, GitHub Copilot CLI, OpenCode, and Pi sessions
